...
public abstract class AbstractAndroid {
	...
	public static final float DEFAULT_VERTICAL_ACCELERATE       = 1 * SuperBabyMainActivity.height_mul;
	protected static final float INITIAL_COORX                  = 145 * SuperBabyMainActivity.width_mul;
	protected static final float INITIAL_COORY                  = 380 * SuperBabyMainActivity.height_mul;
	public static final float INITIAL_VERTICAL_SPEED            = -19 * SuperBabyMainActivity.height_mul;
	public static final float MAX_VERTICAL_SPEED                = 19 * SuperBabyMainActivity.height_mul;
